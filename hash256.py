#!/usr/bin/python3
"""
Take the SHA256 hash of every file inside a directory (excluding symlinks)
...
parser = argparse.ArgumentParser(
    description='Record the Sha256 hash or every file '
...
with open('hash-sha256_%s.json' % get_date(), 'w') as f:
